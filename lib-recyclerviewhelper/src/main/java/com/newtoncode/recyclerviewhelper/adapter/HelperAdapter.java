package com.newtoncode.recyclerviewhelper.adapter;
...
public class HelperAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (headerCount > 0 && position < headerCount) {
            if (headerConvertListener != null) {
                headerConvertListener.convert(holder, position);
            }
        } else if (itemAdapter.getItemCount() > 0 && position >= headerCount && position < headerCount + itemAdapter.getItemCount()) {
    ...
    private HeaderConvertListener headerConvertListener;

    public void setHeaderConvertListener(HeaderConvertListener headerConvertListener) {
        this.headerConvertListener = headerConvertListener;
    }
