package com.newtoncode.recyclerviewhelper;
...
import com.newtoncode.recyclerviewhelper.adapter.HelperAdapter;
import com.newtoncode.recyclerviewhelper.footer.LoadMoreView;
...
import com.newtoncode.recyclerviewhelper.listener.RecyclerViewScrollListener;
import com.newtoncode.recyclerviewhelper.listener.TipsListener;
import com.newtoncode.recyclerviewhelper.utils.LoadMoreUtil;
...
public class RecyclerViewHelper {
    ...
    public void setHeaderConvertListener(HeaderConvertListener headerConvertListener) {
        if (helperAdapter != null) {
            helperAdapter.setHeaderConvertListener(headerConvertListener);
        }
    }
